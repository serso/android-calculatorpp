...
public class JsclMathEngineTest {
    ...
    public void testFormat() throws Exception {
        ...
        try {
            ...
            assertEquals("100.0100 1100 11", me.format(4.3d, NumeralBase.bin));
            assertEquals("1 0001 0101 0011.0101 0101 10", me.format(4435.33423d, NumeralBase.bin));
            assertEquals("1100.0101 0101 01", me.format(12.3333d, NumeralBase.bin));
            assertEquals("1 0011 1101 1110 0100 0011 0101 0101.0001 1111 00", me.format(333333333.1212213321d, NumeralBase.bin));

            assertEquals("0.EE EE EE EE EE", me.format(14d / 15d, NumeralBase.hex));
            ...
            assertEquals("13 DE 43 55.1F 08 5B EF 14", me.format(333333333.1212213321d, NumeralBase.hex));
            assertEquals("D 25 0F 77 0A.6F 73 18 FC 50", me.format(56456345354.43534534523459999d, NumeralBase.hex));
            assertEquals("3 E7.4C CC CC CC CC", me.format(999.3d, NumeralBase.hex));

            me.setRoundResult(false);
            assertEquals("0.00 00 00 00 00 00 00 00 00 6C", me.format(0.00000000000000000000009d, NumeralBase.hex));
            assertEquals("0.00 00 00 00 00 00 00 00 00 0A", me.format(0.000000000000000000000009d, NumeralBase.hex));
    ...
    public void testPiComputation() throws Exception {
        ...
        assertEquals("-1+122.46467991473532E-18*i", me.evaluate("exp(√(-1)*Π)"));
    }
    ...
    public void testEngineeringNotationWithRounding() throws Exception {
        ...
        assertEquals("10E3", me.format(10000d));
        assertEquals("1E3", me.format(1000d));
        ...
        assertEquals("999.999E-6", me.format(0.000999999));
        assertEquals("100E-6", me.format(0.0001));
